...
class _AddTransactionWidgetState extends State<AddTransactionWidget> {
  ...
  Jalali dateTimeSelected = Jalali.now();

  @override
  void initState() {
    _categories = BaseData.categories();
    _dateController.text = dateTimeSelected.toDateTime().toPersianDate();
    super.initState();
  }
          ...
          children: [
            ...
            if (_selectedCategory != null)
              DropdownButtonFormField<Subcategory>(
                key: const Key('subcategoryField'),
  ...
  Future<void> openCalendar() async {
    ...
    if (dateTimeTemp != null && dateTimeTemp != dateTimeSelected) {
      dateTimeSelected = dateTimeTemp;
      _dateController.text = dateTimeSelected.toDateTime().toPersianDateStr();
      // cubitMain.loadMain();
    }
  }
}
